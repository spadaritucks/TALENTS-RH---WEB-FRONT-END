...
import { getAllUsers, HeadHunterProps, UserProps } from "@/api/users/api"
import {
    Table,
    TableBody,
    TableCell,
...
export default function HeadHuntersPanel() {
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {headhunters.map((headhunter) => {
                                const user = users.find(user => user.id === headhunter.user_id)
                                return (
                                    <TableRow key={headhunter.id}>
                                        ...
                                        <TableCell><Link href={`${process.env.NEXT_PUBLIC_API_URL}/storage/${headhunter.cv}`} >Baixar o Curriculo</Link></TableCell>
