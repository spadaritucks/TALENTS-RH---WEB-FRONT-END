...
import { createConsultorAction } from "@/server actions/consultores.action"
import { useActionState, useEffect, useState } from "react"


export default function CriarConsultorForm() {

    const [formErrors, setFormErrors] = useState<{ [key: string]: string[] }>({}) //Objeto responsavel por validação do formulario
    const [data, handleCriarConsultor, isPending] = useActionState(createConsultorAction, null)
