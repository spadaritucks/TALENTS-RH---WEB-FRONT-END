...
export function CadastroForm({ cargos, headhunters, userHeadhunters }: FormProps) {
    ...
    useEffect(()=>{
        headhunter && userHeadhunter ? setForm({
            ...form,
            nome: userHeadhunter.nome,
            sobrenome: userHeadhunter.sobrenome,
            email : userHeadhunter.email,
            celular_1: userHeadhunter.celular_1,
            celular_2: userHeadhunter.celular_2 || '',
            data_nascimento: userHeadhunter.data_nascimento,
            linkedin : userHeadhunter.linkedin || '',
        }) : null
    },[headhunter, userHeadhunter, id])
