...
export function CadastroForm({ userCandidatos }: FormProps) {
    ...
    useEffect(() => {
        userCandidato ? setForm({
            ...form,
            cep: userCandidato.cep,
            logradouro: userCandidato.logradouro,
            cidade: userCandidato.cidade,
            bairro: userCandidato.bairro,
            estado: userCandidato.estado,
            numero: userCandidato.numero,
            latitude: userCandidato.latitude,
            longitude: userCandidato.longitude,
        }) : null
    }, [userCandidato, id])
